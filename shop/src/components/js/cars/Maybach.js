...
function Maybach() {
  ...
  return (
    <div className='mainContainer'>
      ...
      style={{backgroundImage: `url(${maybach_1blur})`}}
      ><img src={maybach_1} className="img2"/>
      </div>
    ...
    <div className='car-info'>
      <div className='car-facts'>
        ...
        <div className='cell'><div>MPG</div><div style={{marginTop:"-1vh", fontSize:"1.5vh"}}>____________</div><div>15/24</div></div>
        <div className='cell'><div>Exterior color</div><div style={{marginTop:"-1vh", fontSize:"1.5vh"}}>____________</div>Rubellite Red Designo, Kalahari Gold Metallic<div></div></div>
        <div className='cell'><div>{"Interior \n \n color"}</div><div style={{marginTop:"-1vh", fontSize:"1.5vh"}}>____________</div>Nappa black<div></div></div>
      ...
      <div className='payment'>
        <div className='payment-container'>
            ...
            <div className='button-text'>{`$185,000`}</div>
            </button>
            <button className='payment-button'>
